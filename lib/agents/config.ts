...
export const loggingAgent = new LlmAgent({
  ...
  instruction: `You are the Logging Agent for EcoTrack.
...
export const visionAgent = new LlmAgent({
  ...
  instruction: `You are the Vision Agent for EcoTrack.
...
export const analyticsAgent = new LlmAgent({
  ...
  instruction: `You are the Analytics Agent for EcoTrack.
...
export const goalPlannerAgent = new LlmAgent({
  ...
  instruction: `You are the Goal Planner Agent for EcoTrack.
...
export const rootAgent = new LlmAgent({
  name: "coordinator",
  model: "gemini-2.5-flash",
  description: "Root Eco-Coach orchestrator that coordinates responses and delegates to specialist agents.",
  instruction: `You are "Eco-Coach", the main coordinator agent for the EcoTrack multi-agent coach system.
